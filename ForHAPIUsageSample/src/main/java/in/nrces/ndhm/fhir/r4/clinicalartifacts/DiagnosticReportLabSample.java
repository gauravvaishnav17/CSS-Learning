...
public class DiagnosticReportLabSample {
	...
	static void init() throws DataFormatException, FileNotFoundException
	{
		...
		String[] fileList = new File("E:\\definitions.xml\\").list(new WildcardFileFilter("*.xml"));
		for(String file:fileList)
		{
			//Parse All Profiles and add to prepopulated support
			sd = parser.parseResource(StructureDefinition.class, new FileReader("E:\\definitions.xml\\"+file));
